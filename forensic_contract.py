...
This module defines byte-level canonicalization and semantic feature boundaries.
It is intentionally free of wall-clock access and global mutable state.
"""
...
def canonical_bytes(value: Any) -> bytes:
    """SHA domain: sorted keys, compact separators, UTF-8, stable scalar form."""
